...
<body>
  ...
  <!-- Managemet Team Section -->
	...
	<!--						   <img src="{{url('public/static-pages-assets/images/t1.jpg')}}" alt="" class="img-fluid">-->
	<!--						</div>-->
	...
	<!--					 <div class="team-position">-->
	<!--						<div class="icon-wthree-top">-->
	<!--						   <img src="{{url('public/static-pages-assets/images/t2.jpg')}}" alt="" class="img-fluid">-->
	<!--						</div>-->
	<!--						<div class="team-text-wthree">-->
	<!--						   <h4>-->
	<!--							  Max Will-->
	...
	<!--					 <div class="team-position">-->
	<!--						<div class="icon-wthree-top">-->
	<!--						   <img src="{{url('public/static-pages-assets/images/t3.jpg')}}" alt="" class="img-fluid">-->
	<!--						</div>-->
	<!--						<div class="team-text-wthree">-->
	<!--						   <h4>-->
	<!--							  Ray Son-->
	...
	<!--					 <div class="team-position">-->
	<!--						<div class="icon-wthree-top">-->
	<!--						   <img src="{{url('public/static-pages-assets/images/t4.jpg')}}" alt="" class="img-fluid">-->
	<!--						</div>-->
	<!--						<div class="team-text-wthree">-->
	<!--						   <h4>-->
	<!--							  Zone Hill-->
    ...
    <!--end of Regional Office -->
     ...
     <section class="gallery" id="gallery" style="padding: 3em; background: #3b5998;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g1.png')}}"><img src="{{url('public/static-pages-assets/images/g1.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g2.png')}}"><img src="{{url('public/static-pages-assets/images/g2.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g3.jpg')}}"><img src="{{url('public/static-pages-assets/images/g3.jpg')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g4.jpg')}}"><img src="{{url('public/static-pages-assets/images/g4.jpg')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g5.jpg')}}"><img src="{{url('public/static-pages-assets/images/g5.jpg')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g6.png')}}"><img src="{{url('public/static-pages-assets/images/g6.png')}}" alt="img" style="width:150px"></a>
                </div>
            </div><!--rnd of row--><br>

            <div class="row">
                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g7.png')}}"><img src="{{url('public/static-pages-assets/images/g7.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g8.png')}}"><img src="{{url('public/static-pages-assets/images/g8.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g9.png')}}"><img src="{{url('public/static-pages-assets/images/g9.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g13.jpg')}}"><img src="{{url('public/static-pages-assets/images/g13.jpg')}}" alt="img" style="width:150px"></a>

                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g11.png')}}"><img src="{{url('public/static-pages-assets/images/g11.png')}}" alt="img" style="width:150px"></a>
                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g12.png')}}"><img src="{{url('public/static-pages-assets/images/g12.png')}}" alt="img" style="width:150px"></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g10.jpg')}}"><img src="{{url('public/static-pages-assets/images/g10.jpg')}}" alt="img" style="width:150px"></a>

                </div>

                <div class="col-md-2">
                    <a target="_blank" href="{{url('public/static-pages-assets/images/g14.jpg')}}"><img src="{{url('public/static-pages-assets/images/g14.jpg')}}" alt="img" style="width:150px"></a>
                </div>
            </div>
        </div>
    </section>
