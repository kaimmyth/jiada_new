                ...
                <ul class="nav navbar-nav" style="    margin-top: 1em;">
                    ...
                    <li><a href="#" data-toggle="dropdown"><span data-hover="dropdown">About Us</span><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{url('career')}}" class="hvr-underline-from-center ">Careers</a></li>
                        </ul>
                    </li> 
                    <li><a href="#" data-toggle="dropdown"><span data-hover="dropdown">Resources</span><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{url('master-plan')}}"><span data-hover="">Master Plans</span></a></li>
					...
					<li><a href="{{url('unit')}}" class="hvr-underline-from-center ">Unit Directory</a></li>
                    <li><a href="{{url('ticket_page')}}" class="hvr-underline-from-center">Support Center</a></li>
