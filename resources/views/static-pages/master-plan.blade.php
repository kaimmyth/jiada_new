...
<body>
    ...
    <section class="master-plan" id="master-plan" style="padding: 3em; background: #fff; padding-top:6em;">
        <div class="container">
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <th scope="col">Master Plan</th>
                </tr>
                </thead>
                <tbody style="    text-transform: lowercase;">
                <tr>
                    <th scope="row">1</th>
                    <td>TUPUDANA INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                    
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td>TATISILWAI INDUSTRIAL AREA PHASE 1</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                ...
                <tr>
                    <th scope="row">4</th>
                    <td>RAMGARH INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">5</th>
                    <td>PATRATU INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">6</th>
                    <td>NAMKOM INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">7</th>
                    <td>LOHARDAGA INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">8</th>
                    <td>KOKAR INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">9</th>
                    <td>JHUMRITILAIYA INDUSTRIAL ESTATE , KODARMA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">10</th>
                    <td>HAZARIBAGH INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">11</th>
                    <td>GUMLA INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                <tr>
                    <th scope="row">12</th>
                    <td>GETALSUD INDUSTRIAL AREA</td>
                    <td><button type="button" class="btn btn-success" style="padding: 3px 20px;">View More</button></td>
                </tr>
                </tbody>
            </table>
