			...
			<div class="topbar-left" style="background: #c8e7ff; border: 2px solid #8BC34A;">
				<div class="text-center">
					<a href="{{url('dashboard')}}" class="logo">
						<span><p style="margin-top:7px;color:#248957;font-size:30px;margin-right: 34px;"><br>CRIS</p></span></a>
					</div>
				</div>
						...
						<ul class="nav navbar-right float-right list-inline">
							...
							<a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light"
								...
								<i class="md md-notifications"></i> <span
									class="badge badge-pill badge-xs badge-danger"><?php echo count($notify); ?></span>
							</a>
							<ul class="dropdown-menu dropdown-menu-lg">
							    @foreach($notify as $noti)
								<li class="list-group">
									<a href="{{ URL('display-ticket/'.$noti->id)}}" class="list-group-item">
										<div class="media">
											<div class="media-left pr-2">
												<i class="md md-storage"></i>
											</div>
											<div class="media-body clearfix">
												<div class="media-heading">{{$noti->requester_name}}</div>
												<p class="m-0">
													<small><span class="text-primary">created a new ticket at</span> {{$noti->created_at}} </small>
												</p>
											</div>
										</div>
									</a>
