          ...
          <div class="row" id="dashboard-row">
             <div class="col-sm-12">
                ...
                <ol class="breadcrumb pull-right">
                   ...
                   <li><a href="{{URL::to('home')}}">Masters</a></li>
                   <li class="active">PCC</li> -->
                </ol>
             </div>
          </div><hr class="new2">
          <div class="row">
       ...
       <div class="modal-content">
          ...
          <form  action="{{ url('add/pcc_master') }}" method="POST" id="FormValidation" enctype="multipart/form-data">
                ...
                <div class="row">
                   <div class="col-md-6">
                      <div class="form-group"> 
                         <label for="field-1" class="control-label">Entry  Name </label> 
                         <input  type="text" id="entry_pcc_name" name="entry_pcc_name" class="form-control" required="" aria-required="true" placeholder="Enter  Name"> 
                      </div>
                   </div>
                   <div class="col-md-6">
                      <div class="form-group"> 
                         <label for="field-2" class="control-label"> Action Name </label> 
                         <input id="pcc_action_name" type="text" name="pcc_action_name" class="form-control" required="" aria-required="true" placeholder="Enter  Action Name"> 
                      </div>
                   </div>
                   <div class="col-md-6">
                      <div class="form-group">
             ...
             <div class="modal-footer"> 
                <button type="submit" id="submitbtn" class="btn btn-outlin-primary">Submit</button>
