        ...
        <div class="container-fluid">
            <form action="{{ URL::to('land/customer/add')}}" method="POST" id="FormValidation" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row" id="dashboard-row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title" style="color: #000; font-weight:200;"><i class="ion-arrow-right-b"></i> &nbsp;Customer :&nbsp;@if(@$editData->id!='') Edit  Info @else Add  @endif / <a href="javascript::void(0);" onclick="history.back();">Back</a></h4>
                        <ol class="breadcrumb pull-right">
                            <!-- <li><a href="{{ URL::to('home') }}">Home</a></li>
                            <li><a href="{{url('land/customer')}}">Customer</a></li>
