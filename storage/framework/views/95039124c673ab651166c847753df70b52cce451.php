                            ...
                            <table id="datatable-responsive" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <thead style="background: #b6e9ff;">
                                    <tr>
                                        ...
                                        <td style="background-color: e1f1f9;"></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e($data->phone); ?></td>
                                        ...
                                        <td class="actions">
                                            <a href="<?php echo e(url('edit/users/from/'.$data->id)); ?>" class="on-default edit-row" onclick="editRecords(<?php echo e($data->id); ?>)" data-toggle="tooltip" data-modal="modal-12" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a> &nbsp;&nbsp;&nbsp;
...
<div id="generic-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mt-0">Generic User info</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?php echo e(url('check_generic')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
                ...
                <hr class="new2">
                <div class="modal-footer">
                    <button type="submit" id="submitbtn" class="btn btn-ouline-primary">Submit</button>
                    <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
...
</script><?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/master/users.blade.php ENDPATH**/ ?>