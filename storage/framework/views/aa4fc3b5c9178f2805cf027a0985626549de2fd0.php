	...
	?>
		...
		<div id="sidebar-menu">
			...
			<ul>
				...
				<li>
				    <a href="<?php echo e(URL::to('customer/list-enterprises')); ?>" class="waves-effect"><i class="ion-android-add-contact"></i>&nbsp;&nbsp;<span>CUSTOMERS</span></a>
			    </li>
			...
			<ul>
				...
				<li class="has_sub">
				    <a href="#" class="waves-effect"><i class="ion-arrow-shrink"></i>&nbsp;&nbsp;MATERIAL<span class="pull-right"><i class="md md-add"></i></span></a>
				    <ul class="list-unstyled">
                        <li>
                            <a href="<?php echo e(url('material_master')); ?>" class="waves-effect"><i class="ion-android-add-contact"></i><span>MATERIAL</span></a>
                        </li>
        				<li>
        				    <a href="<?php echo e(url('land/customer/view&edit/'.Auth::user()->id)); ?>" class="waves-effect"><i class="fa fa-globe"></i><span>MATERIAL MANAGE</span></a>
        				</li>
					</ul>
				</li>
				<li>
                    <a href="<?php echo e(url('create/compan_website/'.Auth::user()->id)); ?>" class="waves-effect">&nbsp;&nbsp;&nbsp;<i class="fa fa-globe"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>&nbsp; CUSTOMIZE WEB</span></a>
                </li>
				<?php endif; ?>
				...
				<li>
				    <a href="<?php echo e(URL::to('pcc/pcc_action_view')); ?>" class="waves-effect"><i class="ion-android-add-contact"></i>&nbsp;&nbsp;<span>PCC  AGENDA</span></a>
				</li>
				<?php endif; ?>
				<?php if(in_array(8, @$module_id)): ?>
				    <?php if(Auth::user()->users_role==3): ?>
				    <li class="has_sub">
				    <a href="#" class="waves-effect"><i class="ion-arrow-shrink"></i>&nbsp;&nbsp;TICKETS<span class="pull-right"><i class="md md-add"></i></span></a>
				    <ul class="list-unstyled">
                        <li>
        				    <a href="<?php echo e(url('company-ticket-form')); ?>" class="waves-effect"><i class="md md-storage"></i>&nbsp;&nbsp;<span>CREATE TICKETS</span></a>
        				</li>
        				<li>
	    			        <a href="<?php echo e(url('ticket')); ?>" class="waves-effect"><i class="md md-storage"></i>&nbsp;&nbsp;<span>VIEW TICKETS</span></a>
        				</li>
					</ul>
					</li>
				    <?php else: ?>
			            <li>
    				        <a href="<?php echo e(url('ticket')); ?>" class="waves-effect"><i class="md md-storage"></i>&nbsp;&nbsp;<span>TICKETS</span></a>
    				    </li>
				    <?php endif; ?>
...
<!-- ============================================================== --><?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/layouts/menubar.blade.php ENDPATH**/ ?>