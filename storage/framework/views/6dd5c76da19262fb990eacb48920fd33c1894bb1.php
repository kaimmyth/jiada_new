<style>
    ...
    <div class="content">                                             
      ...
      <div class="container-fluid">
        ...
        <div class="row" id="dashboard-row">
          <div class="col-sm-12">
            <h4 class="pull-left page-title"  style="color: #000;font-weight:200;">&nbsp;<i class="ion-arrow-right-b"></i> &nbsp;&nbsp; Registration : Edit <a href="javascript::void(0);"  onclick="history.back();" >Back</a></h4>
            <ol class="breadcrumb pull-right">
              <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
              <li><a href="<?php echo e(url('land/registration')); ?>">Registration</a></li>
        ...
        <div class="row" id="default-form">
          ...
          <div class="card"style="border-left: 3px solid #386900;box-shadow: 4px 4px #b1b1b1;">
            <div class="card-header" style="background: linear-gradient(to left, #dbf2fd, #ffffff 50%, #ffffff, #ffffff 75%);">
              <form action="<?php echo e(URL::to('land/editSave/registration')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data" autocomplete="off" >
                <?php echo csrf_field(); ?>
                <div class="card-body" >
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <input type="hidden" name="land_id"  id="land_id">
                        <p>Plot No. : <b style="color: #F0560A;" id="p_no"><?php echo e($toReturn['lease_details']->plot_no); ?></b></p>
                        <!-- <p>Plot No. : <input type="text" name="p_no" value="<?php echo e($toReturn['lease_details']->plot_no); ?>" id="p_no"></p> -->
                        <input type="hidden" name="land_ids" value="<?php echo e($toReturn['lease_details']->land_id); ?>" id="land_ids">
                      </div>
                      <div class="col-md-4">
                        <p>Plot Name :  <b style="color: #F0560A;" id="p_name"><?php echo e($toReturn['lease_details']->land_name); ?></b></p>
                        <!-- <p>Plot Name :   <input type="text" name="p_name" value="<?php echo e($toReturn['lease_details']->land_name); ?>" id="p_name"></p> -->
                      </div>
                      <div class="col-md-4">
                        <p>Size :  <b style="color: #F0560A;" id="p_size"><?php echo e($toReturn['lease_details']->plot_size); ?></b></p>
                        <!-- <p>Size :  <input type="text" name="p_size" value="<?php echo e($toReturn['lease_details']->plot_size); ?>" id="p_size"></p> -->
                        <input type="hidden" name="" id="p_size2"  >
                      </div>
                      <div class="col-md-4">
                        <!-- <p><b style="color: #0AACF0;">Possesion Size  <input type="text" readonly placeholder="Enter value" value="<?php echo e($toReturn['lease_details']->dakhal_kabja); ?>" id="inputval" onkeyup="chkpsige(this.value)"  style="width:72px;" name="dakhal_kabja"><span id="p_uom" style="color: #F70E24;" ></span> </b></p> -->
                        <p>Possesion Size :  <b style="color: #F0560A;" id="inputval"><?php echo e($toReturn['lease_details']->dakhal_kabja); ?></b></p>
                      </div>
                      <div class="col-md-4">
                        <p>Sector :  <b style="color: #F0560A;" id="sect"><?php echo e($toReturn['lease_details']->sector); ?></b></p>
                        <!-- <p>Sector :  <input type="text" name="sect" value="<?php echo e($toReturn['lease_details']->sector); ?>" id="sect"></p> -->
                      </div>
                      <div class="col-md-4">
                        <p>Phase :  <b style="color: #F0560A;" id="phas"><?php echo e($toReturn['lease_details']->area); ?></b></p>
                        <!-- <p>Phase :  <input type="text" name="phas" value="<?php echo e($toReturn['lease_details']->area); ?>" id="phas"></p> -->
                      </div>
                      <div class="col-md-4">
                        <p>Block :  <b style="color: #F0560A;" id="l_block"><?php echo e($toReturn['lease_details']->block); ?></b></p>
                        <!-- <p>Block :  <input type="text" name="l_block" value="<?php echo e($toReturn['lease_details']->block); ?>" id="l_block"></p> -->
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row form-group">
                   <div class="col-sm-7">
                    <div class="input-group" style="margin-top: -47px;">
                      ...
                      <input type="hidden" name="cust_id" value="<?php echo e($toReturn['lease_details']->customerCopmId); ?>" id="cust_id" >
                      <span class="input-group-prepend">
                        <button type="button" class="btn waves-effect waves-light btn-primary"><i class="fa fa-search"></i></button>&nbsp;
                      </span>
                    </div>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-3">
                    <input type="hidden" name="cust_id" value="<?php echo e($toReturn['lease_details']->customerCopmId); ?>" id="cust_id" >
                    <p>Company Name : <b style="color: #F0560A" id="c_name"><?php echo e($toReturn['lease_details']->company_name); ?></b></p>
                    <!-- <p>Company Name : <input type="text" name="c_name" value="<?php echo e($toReturn['lease_details']->company_name); ?>" id="c_name"></p> -->
                  </div>
                  <div class="col-md-3">
                    <p>Type :  <b style="color: #F0560A" id="c_email"><?php echo e($toReturn['lease_details']->company_type); ?></b></p>
                    <!-- <p>Type :  <input type="text" name="c_email" value="<?php echo e($toReturn['lease_details']->company_type); ?>" id="c_email"></p> -->
                  </div>
                  <div class="col-md-3">
                    <p>Company Registration No. :  <b style="color: #F0560A" id="c_Regi"><?php echo e($toReturn['lease_details']->company_reg_no); ?></b></p>
                    <!-- <p>Company Registration No. :  <input type="text" name="c_Regi" value="<?php echo e($toReturn['lease_details']->company_reg_no); ?>" id="c_Regi"></p> -->
                  </div>
                  <div class="col-md-3">
                    <p>Address :  <b style="color: #F0560A" id="c_company"><?php echo e($toReturn['lease_details']->address); ?></b></p>
                    <!-- <p>Address :  <input type="text" name="c_company" value="<?php echo e($toReturn['lease_details']->address); ?>" id="c_company"></p> -->
                  </div>
                </div>
              </div>
              <hr>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" name="application_no" placeholder="Application No" value="<?php echo e($toReturn['lease_details']->application_no); ?>" id="application_no"  placeholder="">
                      <input type="hidden" name="ids" value="<?php echo e($toReturn['lease_details']->id); ?>" id="ids" value="">
                    </div>
                  </div> 
                </div>
                <div class="col-md-5">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control datepicker" placeholder="Application Date" value="<?php echo e($toReturn['lease_details']->application_date); ?>" onchange="chkdate(this.value)" id="appliDate"  name="application_date">
                    </div>
                  </div> 
                </div>
              </div>
              <div class="row">
               <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control  datepicker selector" placeholder="Possession Date" value="<?php echo e($toReturn['lease_details']->possession_date); ?>"   name="possession_date"  placeholder="DD/MM/YYYY">
                  </div>
                </div> 
              </div>
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" placeholder="SSI Registration Number" value="<?php echo e($toReturn['lease_details']->ssi_reg_no); ?>" name="ssi_reg_no" >
                  </div>
                </div> 
              </div>
            </div>
            <div class="row">              
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" placeholder="Registration No" value="<?php echo e($toReturn['lease_details']->registration_no); ?>" name="registration_no" placeholder="">
                  </div>
                </div> 
              </div>
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control datepicker " placeholder="Registration Date" value="<?php echo e($toReturn['lease_details']->registration_date); ?>" name="registration_date" placeholder="">
                  </div>
                </div> 
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="allotment_no" placeholder="Allotment No" value="<?php echo e($toReturn['lease_details']->allotment_no); ?>" placeholder=""  aria-required="true" >
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-5">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control datepicker " placeholder="Allotment Date" name="allotment_date" value="<?php echo e($toReturn['lease_details']->allotment_date); ?>"  aria-required="true" >
                  </div>
                </div> 
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-3 control-label" for="example-input-normal">Base Rent(In Rs) </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->based_rent); ?>" placeholder="₹ 00.00" name="based_rent" id="based_rent"  aria-required="true">
                  </div>
                </div> 
              </div>
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-4 control-label" for="example-input-normal">Insurance(In Rs) </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->insurance); ?>" placeholder="₹ 00.00"  name="insurance" id="insurance"  aria-required="true">
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-4 control-label" for="example-input-normal">Maintanance(In Rs) </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->maintanance); ?>" placeholder="₹ 00.00"  name="maintanance" id="maintanance"  aria-required="true">
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-3 control-label" for="example-input-normal">Taxes(In Rs) </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->tax); ?>" placeholder="₹ 00.00"   name="taxes" id="taxes"  aria-required="true">
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-4 control-label" for="example-input-normal">Additional Charge(In Rs) </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->additional_charge); ?>" placeholder="₹ 00.00"  name="additional_charge" id="additional_charge"  aria-required="true">
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-4 control-label" for="example-input-normal">Net Payable(In Rs)  </label>
                  <div class="col-sm-5">
                    <input type="number" class="form-control" value="<?php echo e($toReturn['lease_details']->net_pay); ?>" placeholder="₹ 00.00"  name="netpaybill" id="netpaybill"  readonly="" aria-required="true">
                  </div>
                </div> 
              </div>
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  <label class="col-sm-3 control-label" for="example-input-normal">Payment Frequency</label>
                  <div class="radio radio-info form-check-inline" style="padding-left: 32px;">
                    <input type="radio" id="inlineRadio1" value="monthly" <?php if($toReturn['lease_details']->net_payable=='monthly'): ?> checked="checked" <?php endif; ?>  name="add_net_payable" >
                    <label for="inlineRadio1"> Monthly </label>
                  </div>
                  <div class="radio form-check-inline">
                    <input type="radio" id="inlineRadio2" value="yearly" name="add_net_payable"  <?php if($toReturn['lease_details']->net_payable=='yearly'): ?> checked="checked" <?php endif; ?>  style="width: 195px;">
              ...
              <div class="col-md-4">
                <div class="row form-group">
                  ...
                  <div class="col-sm-5">
                   <input type="number" class="form-control" name="lease_time" id="lease_time_duration"  value="<?php echo e($toReturn['lease_details']->lease_time); ?>"  style="width: 195px;">
             ...
             <div class="col-md-4">
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                 <div class="input-group">
                  <input type="text" class="form-control"  value="<?php echo e($toReturn['lease_details']->start_date); ?>" placeholder="mm/dd/yyyy" name="start_date" id="start_date"  aria-required="true">
  ...
  <?php /**PATH D:\xampp\htdocs\jiada\resources\views/customer/editSave_registration.blade.php ENDPATH**/ ?>