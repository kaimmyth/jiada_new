      ...
      <div class="row">
        ...
        <div class="card card-border card-info">
          <div class="card-header" style="background-image: linear-gradient(#e9f8ff, white);padding: 0px !important;">
            <div class="card-body">
             <!-- <form method="post" action="<?php echo e(url('filter-customers')); ?>" id="FormValidation" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <button class="btn btn-outline-info btn-rounded" style="margin-top: 30px;" type="submit"><i
                        ...
                        onclick="window.location.href='<?php echo e(url('service/customres')); ?>'">Reset</button>
                      </div>
                    </div>
                  </div>
                </form>-->
                <div class="row"><br><br><br>
                  ...
                  <div class="col-md-12 col-sm-12 col-12">
                   ...
                   <a href="<?php echo e(url('customer/add')); ?>"><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5"  style="float:right; margin-top: 1%;" ><i class="md md-add-circle-outline"></i> Add</button></a><br>
                   <?php endif; ?>
                   <?php else: ?>
                   <a href="<?php echo e(url('customer/add')); ?>"><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5"  style="float:right; margin-top: 1%;" ><i class="md md-add-circle-outline"></i> Add</button></a><br>
                   <?php endif; ?>
                   ...
                   <tbody>
                    ...
                    <?php $__currentLoopData = $customers_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <?php if($user_id!=1): ?>
                      <?php if(@$module_permission['is_edit']=='yes'): ?>
                     
                      <td><a href="<?php echo e(url('land/customer/view&edit',$val->id)); ?>" ><?php if($val->company!=''): ?><?php echo e($val->company); ?>  <?php endif; ?> </a></td>
                      <?php endif; ?>
                      <?php else: ?>
                      <td><?php if($val->company!=''): ?><?php echo e($val->company); ?> <?php endif; ?></td>
                      <?php endif; ?>
                      <td>
                      ...
                      <td class="actions ">
                        <a href="<?php echo e(url('create/compan_website/'.$val->id)); ?>" class="on-default view-row" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Create Website"><i class="fa fa-globe"></i></a> 

                        <?php if($user_id!=1): ?>
                        <?php if(@$module_permission['is_edit']=='yes'): ?>
                        <a href="<?php echo e(url('land/customer/view&edit',$val->id)); ?>" class="on-default view-row" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Update"><i class="fas fa-edit"></i></a> 
                        &nbsp;&nbsp;&nbsp;&nbsp; 
                        <?php endif; ?>
                        <?php else: ?>
                        <a href="<?php echo e(url('land/customer/view&edit',$val->id)); ?>" class="on-default view-row" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Update"><i class="fas fa-edit"></i></a> 
                        ...
                        <a href="<?php echo e(url('land/customercompany/view/'.$val->id)); ?>" class="on-default view-row" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View"><i class="fa fa-eye" aria-hidden="true"></i></a> 
                        &nbsp;&nbsp;&nbsp;&nbsp;    
                        <?php endif; ?>
                        <?php else: ?>
                        <a href="<?php echo e(url('land/customercompany/view/'.$val->id)); ?>" class="on-default view-row" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View"><i class="fa fa-eye" aria-hidden="true"></i></a> 
                        ...
                        <a href="javascript::void(0);" onclick="delete_customer(<?php echo e($val->id); ?>)" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash" style="color:red;"></i></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <?php endif; ?>
                        <?php else: ?>
                        <a href="<?php echo e(url('land/customer/delete/'.$val->id)); ?>"  class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash" style="color:red;"></i></a>
                        <?php endif; ?>
                      </tr>
                  ...
                  <?php echo e($customers_data->links()); ?>
...
<script type="text/javascript">
  ...
  function delete_customer(id) {
    ...
    $.ajax({
      url: "<?php echo e(url('land/customer/delete/')); ?>" + '/' + id,
      method: "POST",
      contentType: 'application/json',
      success: function(data) {
...
<div class="modal fade" id="edit_customer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="<?php echo e(URL::to('land/customer/add')); ?>" method="POST" id="Form" enctype="multipart/form-data" autocomplete="off" >
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH D:\xampp\htdocs\jiada_new\resources\views/customer/manage_customers.blade.php ENDPATH**/ ?>