            ...
            <div  id="company_details">
                ...
                <div class="col-md-10 job-post-info text-left" style="margin-top:4px;" >
                    ...
                    <div class="job-single-sec">
                        <p class="my-2">
                            <a href="<?php echo e($value_comp['company_portal_url']); ?>"><?php echo e($value_comp['nameofUnit']); ?></a>
                             
                            <span class="etlk">
                            <?php echo e($value_comp['typeOfUnit']); ?>
                        ...
                        <ul class="job-list-info">
                            ...
                            <li class="cllrr">
                                ...
                                <?php endif; ?>
                                <?php if($value_comp['email']!=""): ?>
                                   <i class="fa fa-envelope" aria-hidden="true"></i><?php echo e($value_comp['email']); ?>
...
</script><?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/static-pages/unit.blade.php ENDPATH**/ ?>