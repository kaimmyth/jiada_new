...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('public/login_assest/node_modules/bootstrap/dist/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="https://code.getmdl.io/1.3.0/material.blue-deep_purple.min.css" />
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,700" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(url('public/login_assest/css/style.css')); ?>">
            ...
            <div class="col-lg-4 no-padding" style="z-index:1">
                <div class="mlt-content">
                    <div class="imgcontainer">
                       <a href="http://baba.software/index.php"><img src="<?php echo e(url('public/login_assest/img/baba logo.png')); ?>" alt="logo"/></a>
                    </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <div class="col-lg-12 col-lg-offset-1 col-lg-offset-right-1 col-md-12 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right <?php echo e($errors->has('CaptchaCode') ? ' has-error' : ''); ?> " >
                                        <div   class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <?php echo captcha_image_html('LoginCaptcha'); ?><br>
                    ...
                    <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/payroll.png')); ?>" alt="step1">
                            ...
                            <div class="item">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/crm.png')); ?>" alt="step2">
                                <div style="padding: 2em;">
                            ...
                            <div class="item" style="background: #eda0c4;">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/recruitment.png')); ?>" alt="step3">
                                <div style="padding: 2em;">
                            ...
                            <div class="item" style="background: #0ba5a3;">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/lms.png')); ?>" alt="step4">
                                <div style="padding: 2em;">
                            ...
                            <div class="item" style="background: #a3ca71;">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/ar.png')); ?>" alt="step5">
                                <div style="padding: 2em;">
                            ...
                            <div class="item" style="background: #fde7f4;">
                                <img class="img-responsive center-block" src="<?php echo e(url('public/login_assest/img/sales1.png')); ?>" alt="step6">
                                <div style="padding: 2em;">
...
<script src="https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js"></script>
    ...
    <script src="<?php echo e(url('public/login_assest/node_modules/jquery/dist/jquery.min.js ')); ?>"></script>
    <script src="<?php echo e(url('public/login_assest/node_modules/bootstrap/dist/js/bootstrap.min.js ')); ?>"></script>
