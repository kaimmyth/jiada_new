...
<body>
	...
	<script src="<?php echo e(url('public/static-pages-assets/js/easyResponsiveTabs.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(url('public/static-pages-assets/js/owl.carousel.js')); ?>"></script>
    <!-- Recent Trips Script-->
    <script>
        $(document).ready(function() {
...
<?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/static-pages/career.blade.php ENDPATH**/ ?>