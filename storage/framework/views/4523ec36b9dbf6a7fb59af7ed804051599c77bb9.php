                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="address" id="address" required><?php echo e(@$enterprises->address); ?></textarea>
                            <br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <br><br>
                            <label>Turn Over (FY <?php echo e(date('Y', strtotime('-2 year'))); ?>-<?php echo e(date('Y', strtotime('-1 year'))); ?>):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <br><br>
                            <label>Turn Over (FY <?php echo e(date('Y', strtotime('-1 year'))); ?>-<?php echo e(date('Y')); ?>):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" min="1" value="<?php echo e(@$enterprises->number_of_employees); ?>" required name="number_of_employees" id="number_of_employees">
...
<script>
    ...
    // } );
</script><?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/customer/add-enterprise.blade.php ENDPATH**/ ?>