          ...
          <div class="card card-border card-info">
            <div class="card-header" style="  background-image: linear-gradient(#e9f8ff, white);">
              ...
              <table id="datatable-responsive" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                  <?php $__currentLoopData = $subcategorytData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td class="actions">
                      ...
                      &nbsp;&nbsp;&nbsp;
                      <a href="<?php echo e(URL::to('subcategory/destroy',$data->id)); ?>" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a>
                    </td>
                  </tr>
...
<div id="subcategory-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('add/subcategory')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  function editRecords(id) {
    ...
    $.ajax({
      url: "<?php echo e(url('subcategory/edit/')); ?>" + '/' + id,
      method: "POST",
...
</script><?php /**PATH D:\xampp\htdocs\jiada\resources\views/master/subcategory.blade.php ENDPATH**/ ?>