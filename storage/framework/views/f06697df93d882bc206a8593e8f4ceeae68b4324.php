                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" name="company" id="company" value="<?php echo e($customer_details->company); ?>" required="" aria-required="true" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php if($customer_details->login_details != "not found"): ?>
                                <input type="text" class="form-control" name="comapny_user" readonly value="<?php echo e($customer_details->login_details->username); ?>" aria-required="true">
                                <?php else: ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php if($customer_details->login_details!='not found'): ?>
                                <input type="email" class="form-control" name="comapny_email" readonly aria-required="true" value="<?php echo e($customer_details->login_details->email); ?>">
                                <?php else: ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="customer_id" value="<?php echo e($customer_details->cust_id); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
</script><?php /**PATH D:\xampp\htdocs\jiada\resources\views/customer/create_company_website.blade.php ENDPATH**/ ?>