         ...
         <div class="row" id="dashboard-row">
            <div class="col-sm-12">
               ...
               <ol class="breadcrumb pull-right">
                  ...
                  <li><a href="<?php echo e(URL::to('ticket')); ?>">Tickets</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="card" style="background:#0333f445;height: 60px;">
                  <div class="card-body">
                     <form action="<?php echo e(url('ticket')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data" style="margin-top: 4px;">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="btn-group">
                           <div class="btn-group">
                              <select class="form-control" id="priority_id" name="priority_id">
                                 ...
                                 <?php $__currentLoopData = $priorityData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($data->id); ?>"><?php echo e($data->priority_name); ?></option>
                        ...
                        <div class="btn-group" style="float: right;">
                           <?php if(Auth::user()->users_role == 3): ?>
                               <a href="<?php echo e(url('company-ticket-form')); ?>" class="btn  btn-outline-primary btn-rounded waves-effect waves-light m-b-5" style="margin-top: 4px;">Add &nbsp;&nbsp;<i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                           <?php elseif($user_id==1): ?>
                               <button type="button" class="btn  btn-outline-primary btn-rounded waves-effect waves-light m-b-5" data-toggle="modal" data-target=".bs-example-modal-lg" style="margin-top: 4px;"> Add &nbsp;&nbsp;<i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                           <?php else: ?>
                           ...
                           <table id="datatable1" class="table  table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                              <thead style="background: #b6e9ff;">
                                 <tr style="height: 28px;">
                                    <th>Ticket No.</th>
                                    <th data-priority="1">Requester's Information</th>
                                    <th data-priority="1">Subject</th>
                                    <th data-priority="6">Status</th>
                                    <th data-priority="6">Priority</th>
                                    <th data-priority="6">Dept.</th>
                                    <th data-priority="1">POC</th>
                                    <th data-priority="1">Assigned By</th>
                                    <th data-priority="6">Created Date</th>
                                    <td style="width:90px;" data-priority="6" style="background-color: e9f8ff;"></td>
                                 </tr>
                              </thead>
                              <tbody id="myTable">
                                 <?php $__currentLoopData = $ticketData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr style="height: 28px;">
                                    <td class="text-right"><?php echo e($data->ticket_id); ?></td>
                                    <td><?php if($data->created_name)
                                            {echo $data->created_name;}
                                            else{echo $data->requester_name.'/';            echo $data->email.'/';
                                                echo $data->phone;}?></td>
                                    <td><?php echo e($data->subject); ?></td>
                                    <td><?php echo e($data->status_name); ?></td>
                                    <td><?php echo e($data->priority_name); ?> </td>
                                    <td><?php echo e($data->department_name); ?></td>
                                    <td><?php echo e($data->name); ?> </td>
                                    <td><?php echo e($data->assigned_name); ?></td>
                                    <td class="text-right"><?php echo e(date('d/m/Y',strtotime($data->created_at))); ?> &nbsp;</td>
                                    <td>
                                       <?php if(Auth::user()->users_role == 1): ?>
                                       <a onclick="viewTickethistory(<?php echo e(@$data->id); ?>,'history')"  data-toggle="tooltip"  data-placement="top" title="" data-original-title="Ticket History" href="javascript::void(0)"><i class="fa fa-history" ></i></a>&nbsp;
                                       <?php if($user_id!=1): ?>
                                       <?php if(@$module_permission['is_read']=='yes'): ?>  
                                       <a onclick="viewRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a>&nbsp;   
                                       <?php endif; ?>
                                       <?php else: ?>
                                       <a onclick="viewRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a>&nbsp;
                                       <?php endif; ?>
                                       ...
                                       <a onclick="editRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>&nbsp;
                                       <?php endif; ?>
                                       <?php else: ?>
                                       <a onclick="editRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>&nbsp;
                                       <?php endif; ?>
                                       ...
                                       <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo e(URL::to('delete/ticket',@$data->id)); ?>" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                                       <?php endif; ?>
                                       <?php else: ?>
                                       <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo e(URL::to('delete/ticket',@$data->id)); ?>" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                                       <?php endif; ?>
                                       <?php else: ?>
                                       <a onclick="viewTickethistory(<?php echo e(@$data->id); ?>,'history')" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Ticket History"><i class="fa fa-history"></i></a>&nbsp;
                                       <?php if($user_id!=1): ?>
                                       <?php if(@$module_permission['is_read']=='yes'): ?>  
                                       <a onclick="viewRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a>&nbsp;   
                                       <?php endif; ?>
                                       <?php else: ?>
                                       <a onclick="viewRecords(<?php echo e(@$data->id); ?>)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="View" href="javascript::void(0)"><i class="fa fa-eye"></i></a>&nbsp;
                                       <?php endif; ?>
                                       <?php if(Session::get('gorgID') != $data->created_by): ?>
                                       <a onclick="editRecords(<?php echo e(@$data->id); ?>)" href="javascript::void(0)" data-toggle="tooltip"  data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>&nbsp;
                                       <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                  ...
                  <div class="modal-dialog modal-lg">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form action="<?php echo e(url('add/ticket')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                       ...
                                       <div class="col-md-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" id="department_id" name="department_id">
                                                ...
                                                <?php $__currentLoopData = $departmentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       ...
                                       <div class="col-md-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" id="subDept" name="subDept">
                                                ...
                                                <?php if($subDeptData !=''): ?>
                                                <?php $__currentLoopData = $subDeptData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->subdepartment_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                       ...
                                       <div class="col-md-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" id="poc_id" name="poc_id" required>
                                                ...
                                                <?php if($data->id > 1): ?>
                                                <option value="<?php echo e($data->id); ?>" <?php if($data->generic_id==1){echo "selected";} ?>> <?php echo e($data->name); ?>
                                       ...
                                       <div class="col-md-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" id="status_id_chek" name="status_id_chek">
                                                <option value=""> Select Status </option>
                                                <?php if($statusCheckDATA !=''): ?>
                                                <?php $__currentLoopData = $statusCheckDATA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($data->status_name !='Reopen'): ?>
                                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->status_name); ?></option>
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                             </select>
                           ...
                           <div class="modal-body">
                              <div class="row">
                                  ...
                                  <ul class="nav nav-tabs" role="tablist">
                                	<li class="nav-item">
                                		<a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Details</a>
                                	</li>
                                	<li class="nav-item">
                                	...
                                	<div class="tab-pane" id="tabs-2" role="tabpanel">
                                		<div class="row">
                                		    <div class="col-md-12">
                                		        <div class="row">
                            <div class="col-md-4">
                                <p>Ticket No.: <span class="id"></span></p>
                            </div>
                            <div class="col-md-4">
                                <p>Subject:<span class="ticket_sub"></span></p>
                            </div>
                            <div class="col-md-4">
                                <p>Creation Date:<span class="created_date"></span></p>
                            </div>
                        </div>
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                           ...
                           <tbody id="myhistoryTable">
                                <tr style="height: 28px;">
                                 ...
                                 <td class="assigned_by"> </td>
                                 <td class="description_ticket"> </td>
                              </tr>
                           </tbody>
                        </table>
               ...
               <div class="modal fade" id="view_ticket_history" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
                  <div class="modal-dialog modal-lg">
                     <div class="modal-content">
                        ...
                        <table id="datatable-responsive" class="table  table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                           <thead style="background: #b6e9ff;">
                              <tr style="height: 28px;">
                                 <th>Date</th>
                                 <th>Status</th>
                           ...
                           <tbody id="myhistoryTable">
                                <tr style="height: 28px;">
                                 <td class=" text-right history_date"> </td>
                                 <td class="ticket_status"> </td>
                                 <td class="assigned_to"> </td>
                                 <td class="assigned_by"> </td>
                                 <td class="description_ticket"> </td>
...
<script type="text/javascript">
   function editRecords(id) {
    //   alert(id);
      ...
      $.ajax({
         url: "<?php echo e(url('edit/ticket/')); ?>" + '/' + id,
         method: "POST",
...
<script type="text/javascript">
   function viewRecords(id) {
      ...
      $.ajax({
         url: "<?php echo e(url('view/ticket/')); ?>" + '/' + id,
         method: "POST",
         contentType: 'application/json',
         success: function (data) {
            ...
            document.getElementById("status_id_chek1").innerHTML = data.ticket.status_name;
...
<script type="text/javascript">
   function viewTickethistory(id,type) {
      $.ajaxSetup({
         headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         }
      ...
      $.ajax({
         url: "<?php echo e(url('ticket/history')); ?>" + '/' + id,
         method: "POST",
         contentType: 'application/json',
         success: function (data) {
            $('.id').attr('colspan',1);
            ...
            if(data.length){
                  $.each(data, function (index, value) {
                      if(index==0){
                        ...
                        // alert(index);
                        $(".id").append(this.ticket_no ? this.ticket_no : '');        
                        $(".created_date").append(this.created_date + '<br>');
                        $(".ticket_sub").append(this.subject + '<br>');
                      }
                  $(".history_date").append(this.assigned_date + '<br>');
                  $(".assigned_by").append(this.assign_by + '<br>');
                  $(".assigned_to").append(this.assign_to + '<br>');
                ...
                $('.id').attr('colspan',6);
                $(".id").append('Do not have Ticket History' + '<br>');
                if(type=='history'){
                      $('#view_ticket_history').modal('show');
                  } 
            }
...
<!-- <script type="text/javascript">
   $('#category').change(function(){
      ...
      if(categoryID){
       $.ajax({
          type:"GET",
          url:"<?php echo e(url('get_subid')); ?>?category="+categoryID,
          success:function(data){               
           if(data)
           {
              $("#subcategory").empty();
...
<script type="text/javascript">
   $('#department_id').change(function () {
      ...
      if (departmentID) {
         $.ajax({
            type: "GET",
            url: "<?php echo e(url('get_pocid/')); ?>" + '/' + departmentID,
            success: function (data) {
               if (data) {
                  $("#poc_id").empty();
...
<script type="text/javascript">
   $('#status_id_chek').change(function () {
      ...
      if (StatusID) {
         $.ajax({
            type: "GET",
            url: "<?php echo e(url('get_statusid/')); ?>" + '/' + StatusID,
            success: function (data) {
               if (data) {
                  $("#assigne_to").empty();
                  $("#assigne_to").append('<option>Select User</option>');
...
</script> --><?php /**PATH D:\xampp\htdocs\jiada_new\resources\views/ticket/listing.blade.php ENDPATH**/ ?>