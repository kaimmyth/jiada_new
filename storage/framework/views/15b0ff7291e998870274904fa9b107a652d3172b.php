...
<div class="content-page">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row"><br><br><br>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <a href="<?php echo e(url('enterprise/add')); ?>"><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5" style="float:right; margin-top: 1%;"><i class="md md-add-circle-outline"></i> Add</button></a><br>
    ...
    <?php /**PATH D:\xampp\htdocs\jiada_new\resources\views/list_enterprise.blade.php ENDPATH**/ ?>