<div class="content-page"> 
          ...
          <div class="row" id="dashboard-row">
             <div class="col-sm-12">
                ...
                <ol class="breadcrumb pull-right">
                   ...
                   <li><a href="<?php echo e(URL::to('home')); ?>">Masters</a></li>
                   ...
                   <div class="card-header" style="background-image: linear-gradient(#e9f8ff, white);">
                      ...
                      <table id="datatable-responsive" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       ...
                       <button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5" style="float: right;margin-top: 0px !important;" onclick="addRecords()" >Add <i class="md md-add-circle-outline"></i></button>
                         ...
                         <tbody>
                            <?php $__currentLoopData = $materialsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                               <td class="text-right"><?php echo e($key+1); ?>.&nbsp;</td>
                               <td><?php echo e($data->material_name); ?></td>
                               <td style="white-space:normal; width:200px;"><?php echo e($data->material_description); ?></td>
                              ...
                              <?php endif; ?>
                               ...
                               <td class="actions">
                                  ...
                                  &nbsp;&nbsp;&nbsp;
                                  <a href="<?php echo e(URL::to('material_master/destroy',$data->id)); ?>" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash" style="color:red;"></i></a>
                                </td>
                            </tr>
 ...
 <div id="material-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
       <div class="modal-content">
          ...
          <form  action="<?php echo e(url('add/material_master')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
             <?php echo csrf_field(); ?>
 ...
 <script type="text/javascript">
    function editRecords(id) { 
     ...
     $.ajax({
      url:"<?php echo e(url('material_master/edit/')); ?>"+'/'+id,  
      method:"POST", 
 ...
 </script><?php /**PATH D:\xampp\htdocs\jiada\resources\views/master/indexmaterial.blade.php ENDPATH**/ ?>