        ...
        <div class="row" id="dashboard-row">
            <div class="col-md-12">
                <h4 class="pull-left page-title" style="color: #000; font-weight:200;"><i class="ion-arrow-right-b"></i>
                    &nbsp;&nbsp;<?php if(@$editData->id!=''): ?> Update Customer Info <?php elseif(Auth::user()->users_role==3): ?>
                    Customize Web <?php else: ?> Create Customer <?php endif; ?> / <a href="javascript::void(0);"
        ...
        <form action="<?php echo e(url('add/company_website')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" name="company" id="company"
                                value="<?php echo e($customer_details->nameofUnit); ?>" required="" aria-required="true"
                                placeholder="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="company_portal_url" id="company"
                                value="<?php echo e($customer_details->company_portal_url); ?>" required="" aria-required="true"
                                placeholder="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea name="company_description" class="form-control"
                                style="height: 36px;"><?php echo e($customer_details->company_description); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="welcome_heading" readonly
                                    value="<?php echo e($customer_details->welcome_heading); ?>" aria-required="true">
                                <?php else: ?>
                                <input type="text" class="form-control" name="welcome_heading" value=" "
                                    aria-required="true">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" cols="50" name="welcome_desc"
                                    id="welcome_desc"><?php echo e($customer_details->welcome_desc); ?></textarea>
                                <?php else: ?>
                                <textarea class="form-control" rows="4" cols="50" name="welcome_desc"
                                    id="welcome_desc"></textarea>
                                <?php endif; ?>
                        ...
                        <div class="col-md-6" style="margin-top: 0em;padding: 1em;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mate_heading" readonly
                                        value="<?php echo e($customer_details->mate_heading); ?>" aria-required="true">
                                    <?php else: ?>
                                    <input type="text" class="form-control" name="mate_heading" value=" "
                                        aria-required="true">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" cols="50" name="mate_description"
                                        id="mate_description"><?php echo e($customer_details->mate_description); ?></textarea>
                                    <?php else: ?>
                                    <textarea class="form-control" rows="4" cols="50" name="mate_description"
                                        placeholder="Material description" id="mate_description"></textarea>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mat_web" name="mat_web_name[]" id="mat_web_name"
                                        value="<?php echo e($material->mat_web_name); ?>" aria-required="true" placeholder="">
                                </div>
                                <div>
                                    <button type="button" class="btn btn-outline-danger delete-button-web-material" style="margin-top: 23px;"><i
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <label for="field-6" class="control-label">Material Name</label>
                                        <input type="text" class="form-control mat_web" name="mat_web_name[]" id="mat_web_name"
                                            aria-required="true" placeholder="Material Name">
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-outline-danger delete-button-web-material"
                                        style="height: 34px;margin-top: 23px;"><i class="fa fa-times" title="Remove"></i></button>
                                </div>

                                <div class=" plss1">
                                    <tr>
                                        <span style="text-align:right;" colspan="2"><i class="fa fa-plus-circle"
                                                title="Add More" aria-hidden="true" style="color:green;"
                                                onclick="web_mat_section();"></i></span>
                                    </tr>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <a
                                    href=""><?php echo e($customer_details->banner); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="company_logo_pre"
                                    value="<?php echo e($customer_details->company_logo); ?>">
                                <a
                                    href=""><?php echo e($customer_details->company_logo); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="color" id="color"
                                    value="<?php echo e($customer_details->header_color); ?>" aria-required="true" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="field-6" class="control-label">Banner Header</label>
                                <input type="text" class="form-control" name="banner_heading" id="header_heading"
                                    value="<?php echo e($customer_details->banner_heading); ?>" aria-required="true" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="1" cols="50" name="banner_description"
                                    placeholder="Banner description"
                                    id="header_description"><?php if($customer_details->banner_description): ?> <?php echo e($customer_details->banner_description); ?> <?php endif; ?></textarea>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="service_name[]" id="service_name"
                                value="<?php echo e($value_services->services_name); ?>" aria-required="true" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="services_heading[]"
                                value="<?php echo e($value_services->services_heading); ?>" aria-required="true" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="field-6" class="control-label">Services Description</label>
                            <textarea class="form-control" name="services_description[]"
                                value="<?php echo e($value_services->services_description); ?>"><?php echo e($value_services->services_description); ?></textarea>
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-outline-danger delete-button-material" style="margin-top: 23px;"><i
                                class="fa fa-times" title="Remove"></i></button>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card" style="padding: 1em;">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="field-6" class="control-label">Services Heading</label>
                                <input type="text" class="form-control" name="services_heading[]" aria-required="true"
                                    placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-outline-danger delete-button-material"
                            style="margin-top: 23px;"><i class="fa fa-times" title="Remove"></i></button>
                        </div>
                        <div class="col-md-3">
                            <div class="plss4">
                                <tr>
                                    <span style="text-align:right;" colspan="2">
                                        <i class="fa fa-plus-circle" aria-hidden="true" style="color:green;"
                                            title="Add More" onclick="service_section();"></i>
                                    </span>
                                </tr>
                            </div>
                        </div>
                ...
                <?php endif; ?>
                <div class="row" id="service_iteams_append" class="product_append">
                </div>
                <div class="plss1" style="margin-top: 0em;">
                    <tr>
                        <span style="text-align:right;" colspan="2">
                            <i class="fa fa-plus-circle" aria-hidden="true" title="Add More" style="color:green;"
                                onclick="service_section();"></i>
                        </span>
                    </tr>
                </div>
            </div>
            ...
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="product_name[]"
                                    value="<?php echo e($value_product['product_name']); ?>" id="service_name" aria-required="true"
                                    placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="product_heading[]"
                                    value="<?php echo e($value_product['product_heading']); ?>" aria-required="true" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="product_image_pre[]"
                                    value="<?php echo e($value_product['product_image']); ?>">
                                <a
                                    href="<?php echo e(url('public/company_doc/'.$value_product['product_image'])); ?>"><?php echo e($value_product['product_image']); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"
                                    name="product_description[]"><?php echo e($value_product['product_description']); ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <button type="button" class="btn btn-outline-danger delete-button-material" style="margin-top: 23px;"><i
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label for="field-6" class="control-label">Product Name</label>
                                <input type="text" class="form-control" name="product_name[]" id="service_name"
                                    aria-required="true" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="field-6" class="control-label">Product Heading</label>
                                <input type="text" class="form-control" name="product_heading[]" aria-required="true"
                                    placeholder="">
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="col-md-10">
                    <center><input type="submit" class="btn btn-outline-primary" value="Submit"
                            style=" padding: 6px 22px;font-size: 14px;"></center>
...
<script>
    function product_section() {
        var product_item = `<div class="row" style="width: 100%;margin-left: 0em;">
                            ...
                            <div class="col-md-4">
                                <button type="button" class="btn btn-outline-danger delete-button-material" style="margin-top: 23px;" > <i class="fa fa-times" title="Remove"></i></button>
                            </div>
                    </div>`;
...
<script>
    function web_mat_section() {
        var web_mat_iteams = `<div class="row">
                            <div class="col-md-10">
                                ...
                                <button type="button" class="btn btn-outline-danger delete-button-web-material pull-right " style="height: 35px;margin-top: 23px;" ><i class="fa fa-times" title="Remove"></i></button>
                        </div>`;
    ...
    function service_section() {
        var service_iteams = `<div class="row" style="width: 100%;margin-left: 0em;">
                            ...
                            <div class="col-md-3">
                                <button type="button" class="btn btn-outline-danger delete-button-material " style="margin-top: 23px;" title="Remove"><i class="fa fa-times" title="Remove"></i></button>
                            </div>
                        </div>
                        `;
...
<script>
    $(document).ready(function () {
        ...
        $("body").delegate(".delete-button-web-material", "click", function () {
            $(this).closest(".mat_web").remove();
        });
    });
</script><?php /**PATH C:\xampp\htdocs\jiada_new\resources\views/customer/create_company_website.blade.php ENDPATH**/ ?>