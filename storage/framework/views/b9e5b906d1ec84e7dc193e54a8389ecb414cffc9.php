      ...
      <div class="row" id="dashboard-row">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb pull-right">
            ...
            <li><a href="<?php echo e(URL::to('land/area-location')); ?>">Location</a></li>
                  ...
                  <div class="table-responsive" id="arealocation" style="display: none;">
                    <table id="datatable-responsive" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-right" style="width: 2%;"><?php echo e($i); ?></td>
                          <td><?php echo e($val->sector_zone); ?></td>
                          <td class="text-right" style="width: 2%;"><?php echo e(date('d/m/Y',strtotime($val->created_at))); ?></td>
                    ...
                    <table id="datatable" class="table  table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      <thead>
                        <tr>
                          ...
                          <th>Zone</th>
                          <th>Sector/Phase</th>
                          <th style="width: 2%;">Created Date</th>
...
</script><?php /**PATH D:\xampp\htdocs\jiada\resources\views/land/area_location.blade.php ENDPATH**/ ?>